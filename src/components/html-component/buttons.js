			...
			<div class="col-md-6">
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<input class="btn btn-info" type="button" value="Input"></input>
					    ...
					    <div class="col-md-6">
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<input class="btn btn-outline-info" type="button" value="Input"></input>
										<input class="btn btn-outline-success" type="submit" value="Submit"></input>
											<input class="btn btn-outline-warning" type="reset" value="Reset" ></input>
											</div>
										</div>
